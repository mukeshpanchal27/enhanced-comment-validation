...
class Enhanced_Comment_Validation_Admin
{
    ...
    public function enhanced_comment_validation_update_plugin()
    {
        ...
        // if (!isset($enhanced_comment_validation_settings['_enable_woocommerce_reviews_validation']) && !empty($enhanced_comment_validation_settings)) {
        //     $enhanced_comment_validation_settings_new_elements = array();
        //     $enhanced_comment_validation_settings_new_elements['_enable_woocommerce_reviews_validation'] = 'yes';
					...
					<tbody>
						...
						<?php if (class_exists('WooCommerce')) { ?>
							...
							<tr>
								<td>
									<label class="enhanced-comment-validation-switch">
										<input type="checkbox" class="checkbox" name="enhanced_comment_validation_settings[_enable_woocommerce_reviews_validation]" value="yes"<?php echo (isset($enhanced_comment_validation_settings['_enable_woocommerce_reviews_validation']) && 'yes' === esc_attr($enhanced_comment_validation_settings['_enable_woocommerce_reviews_validation'])) ? ' checked="checked"' : ''; ?> />
										<div class="enhanced-comment-validation-slider"></div>
									</label>
									<label for="" class="enhanced-comment-validation-switch-lable" ><?php _e('WooCommerce Reviews Comment Validation', 'enhanced-comment-validation'); ?></label>
								</td>
							</tr>
						<?php } ?>										
						<tr>
						...
						<tr>
							<td>
								<ul>
									<li class="enhanced-comment-validation-lable-input-switch">
										<label class="enhanced-comment-validation-switch">
											<input type="checkbox" class="checkbox" name="enhanced_comment_validation_settings[_enable_woocommerce_review]" value="yes"<?php echo (isset($enhanced_comment_validation_settings['_enable_woocommerce_review']) && 'yes' === esc_attr($enhanced_comment_validation_settings['_enable_woocommerce_review'])) ? ' checked="checked"' : ''; ?> />
											<div class="enhanced-comment-validation-slider"></div>
										</label>
										<label for="" class="enhanced-comment-validation-switch-lable" ><?php _e('Enable WooCommerce Review Validation', 'enhanced-comment-validation'); ?></label>
									</li>
									<li class="enhanced-comment-validation-input-section">
										<label for="" class="enhanced-comment-validation-lable-input-section"><?php _e('Review', 'enhanced_comment_validation'); ?></label>
										<input type="text" class="enhanced-comment-validation-form-input" name="enhanced_comment_validation_settings[_woocommerce_review_message]" placeholder="<?php _e('Please enter your Review', 'enhanced_comment_validation'); ?>" value="<?php echo isset($enhanced_comment_validation_settings['_woocommerce_review_message']) ? esc_html($enhanced_comment_validation_settings['_woocommerce_review_message']) : ''; ?>">
									</li>
								</ul>
							</td>
						</tr>
